...
console.log(maskCreditCard(43300302300));
console.log(maskCreditCard(2230023958859));
console.log(maskCreditCard('12839180948290423098429043'));
...
// rest
//   .set('categoriez', ['Italian', 'Pizzeria', 'Vegetarian', 'Organic'])
//   .set('open', 11)
//   .set('close', 23)
...
// console.log(new Set(['Waiter', 'Chef', 'Waiter', 'Menager', 'Chef', 'Waiter']));
...
// console.log(restaurant.openingHours.openingHours?.mon?.open);
...
// // REST, becose on the LEFT side of =
...
// ];
// console.log(pizza, risotto, outerHeight);
